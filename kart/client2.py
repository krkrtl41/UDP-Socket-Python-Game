...
class Ui_Dialog(QtWidgets.QDialog):
    ...
    def __init__(self):
        ...
        istemci.sendto(bytes("1010", encoding="utf-8"),  (host, port))
    ...
    def mesaj_isle(self, mesaj):
        if "." in mesaj and mesaj.startswith("x"):
            sonHal = mesaj.split(".")
            if len(sonHal) == 3:
        ...
        elif "." in mesaj and mesaj.startswith("y"): 
            sonHal = mesaj.split(".")
            if len(sonHal) == 6:
                oyuncuPuan = sonHal[1]
                self.oyuncu1Puan.setText(str(oyuncuPuan))
                kartNo1 = sonHal[2]
                kartNo2 = sonHal[3]
                deger1 =  sonHal[4]
                deger2 = sonHal[5]
            ...
            if self.secmeSirasi % 2 == 1:
                ...
                if sayi1 == sayi2:
                    self.puan += 10
                    self.oyuncu2Puan.setText(str(self.puan))
            ...
            final = "Oyun Tamamlandı.\nSizin Puanınız : " + str(oyuncu2Puan) + "\n" + "Rakibin Puanı : " + str(oyuncu1Puan)
...
"color: white;")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "OYUNCU 2"))
